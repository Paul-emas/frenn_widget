...
const CreditLoansTabs = ({ creditLimit, isExisting, merchantDataObj }) => {
	...
	return (
		<div className={`credit__container ${showHideClass}`}>
			<div className="credit__sub">
				...
				<span className="credit__amount">N{merchantDataObj?.amount?.toLocaleString()}</span>
			</div>
...
CreditLoansTabs.defaultProps = {
	isExisting: 'new_user',
};

CreditLoansTabs.propTypes = {
